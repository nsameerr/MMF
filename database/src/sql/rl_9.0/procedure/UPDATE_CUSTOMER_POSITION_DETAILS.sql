...
BEGIN
	...
	H.processedQty = H.processedQty + H.`DpHolding` + H.`NsePool` + H.`NseUnAc`
	...
	H.processedQty = H.processedQty + H.`DpHolding` + H.`BsePool` + H.`BseUnAc`
	...
	H.processedQty = H.processedQty + H.`DpHolding`
