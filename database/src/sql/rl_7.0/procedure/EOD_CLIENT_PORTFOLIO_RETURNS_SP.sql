...
BEGIN
	...
	/*SET P_EOD_CUURRENTDATE = IF(P_EOD_CUURRENTDATE = '',CURRENT_DATE,P_EOD_CUURRENTDATE);*/
	
	/* *** Selecting Order date for the perticular portfolio *** */
	/** Market value = (Day1 qty * Day2 price)
	    market value after cash_flow  = (Day1 qty * Day2 price)+Cash flow
	    Sub return = ((Day1 qty * Day2 price)-Day1 market value after cash_flow)/Day1 market value after cash_flow  
	**/
	SELECT ROUND(AVG(`close`),2) INTO p_CloseValue FROM `benchmark_performance_tb` WHERE `benchmark` = 
        ...
        /* *** Customer Portfolio Returns Calculation --- Insertion into `customer_portfolio_performance_tb` *** */
	...
	/* *** Customer recomended customer Portfolio Returns Calculation --- Insertion into `recomended_customer_portfolio_performance_tb` **/
	...
	/* *** Customer Asset Class Portfolio Returns Calculation --- Insertion into `customer_portfolio_performance_tb` **/
	...
	/* *** Customer Portfolio Securites Returns Calculation --- Insertion into `customer_portfolio_performance_tb` *** */
