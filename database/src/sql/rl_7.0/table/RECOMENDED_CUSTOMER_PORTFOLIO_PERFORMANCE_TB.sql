CREATE TABLE `recomended_customer_portfolio_performance_tb`
(
...
KEY `recomended_customer_portfolio_performance_tb_fk_1` (`customer_portfolio_id`),
CONSTRAINT `recomended_customer_portfolio_performance_tb_fk_1` FOREIGN KEY (`customer_portfolio_id`) REFERENCES `customer_portfolio_tb` (`customer_portfolio_id`)
);
