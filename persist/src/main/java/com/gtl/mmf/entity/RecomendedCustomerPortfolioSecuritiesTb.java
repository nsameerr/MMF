...
/**
 * RecomendedCustomerPortfolioSecuritiesTb generated by hbm2java
 */
public class RecomendedCustomerPortfolioSecuritiesTb  implements java.io.Serializable {


     private Integer recomendedCustomerPortfolioSecuritiesId;
    ...
    public RecomendedCustomerPortfolioSecuritiesTb() {
    }

	
    public RecomendedCustomerPortfolioSecuritiesTb(CustomerPortfolioDetailsTb customerPortfolioDetailsTb, PortfolioDetailsTb portfolioDetailsTb, PortfolioSecuritiesTb portfolioSecuritiesTb, MasterAssetTb masterAssetTb, CustomerPortfolioTb customerPortfolioTb, PortfolioTb portfolioTb, String securityId) {
    ...
    public RecomendedCustomerPortfolioSecuritiesTb(CustomerPortfolioDetailsTb customerPortfolioDetailsTb, PortfolioDetailsTb portfolioDetailsTb, PortfolioSecuritiesTb portfolioSecuritiesTb, MasterAssetTb masterAssetTb, CustomerPortfolioTb customerPortfolioTb, PortfolioTb portfolioTb, String securityId, BigDecimal currentUnits, Float currentPrice, Float currentValue, Float currentWeight, BigDecimal exeUnits, Float recommentedPrice, Float avgAcquisitionPrice, Float initialValue, Float initialWeight, Float requiredValue, BigDecimal requiredUnits, Boolean rebalanceRequired, Date rebalanceReqdDate, Float newAllocation, String securityDescription, Integer newToleranceNegativeRange, Integer newTolerancePositiveRange, String venueCode, String venueScriptCode, String securityCode, Boolean status, String instrumentType, Date expirationDate, BigDecimal strikePrice, BigDecimal yesterDayUnitCount) {
       this.customerPortfolioDetailsTb = customerPortfolioDetailsTb;
       this.portfolioDetailsTb = portfolioDetailsTb;
       this.portfolioSecuritiesTb = portfolioSecuritiesTb;
       this.masterAssetTb = masterAssetTb;
    ...
    public Integer getRecomendedCustomerPortfolioSecuritiesId() {
        return this.recomendedCustomerPortfolioSecuritiesId;
    }
    
    public void setRecomendedCustomerPortfolioSecuritiesId(Integer recomendedCustomerPortfolioSecuritiesId) {
        this.recomendedCustomerPortfolioSecuritiesId = recomendedCustomerPortfolioSecuritiesId;
    }
