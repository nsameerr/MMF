	...
	$.fn.speedometer = function( options ){
                        ...
                        var def = {
                            ...
                            thisCss: {
                                ...
                                fontFamily: 'Arial',
                                fontWeight: '900',
                                backgroundImage : "url('../../img/riskometer.jpg')"
                        ...
                        if ( def.limit && ( def.percentage > def.maximum || def.percentage < def.minimum ) ) {
                            /* the glass cracks */
                            $this.css( 'backgroundImage' , 'url("../../img/riskometer.jpg")' );
                        } else {
                            ...
                            $this.jqcanvas ( function ( canvas, width, height ) {
                                ...
                                function animate(){     
                                    ...
                                    ctx.clearRect( -200, -200, 350, 350 ); //erase the canvas
