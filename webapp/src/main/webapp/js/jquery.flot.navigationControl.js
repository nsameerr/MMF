...
; (function ($) {
    ...
    function drawNavigationControl(plot, canvascontext) {
        ...
        var buttonTemplate = "<div class='{0}' style='box-sizing: border-box; position: absolute;height: 28px; width: 28px; border: solid 1px #666; padding: 0; line-height: 28px; border-radius: 5px; cursor: pointer; background-color: #f5f5f5; display: inline-block; text-align: center; -webkit-box-shadow: 0 0 4px rgba(0, 0, 0, 0.15); box-shadow: 0 0 4px rgba(0, 0, 0, 0.15); text-shadow: 1px 1px 5px rgba(100, 100, 100, 0.75);'><div><span class='icon' style='color: #666; vertical-align: baseline;{2}'>{1}</span></div></div>";

        var horizontalZoomin ="";
        var zoomin = "";
        var verticalZoomin ="";
        ...
        var horizontalZoomout = "";
        var zoomout ="";
        var verticalZoomout = "";

        var panup ="";

        var panright = buttonTemplate.format('pan-right','→', '');

        var pandown = "";

        var panleft = buttonTemplate.format('pan-left','←', '');
