...
<!doctype html>
    ...
    <body  ng-app="appMMF" ng-controller="FinancialPlannerOutput">
		...
		<%
			if(session != null){
				if(session.getAttribute("storedValues")!= null){
					...
					response.sendRedirect("/pages/v2/home.html");
				}
			}
		%>
	    <div class="container-fluid" >
			...
			<div id="divContent">
				<div class="row">
							...
							<div class="panel-body">
								<div id="chartRangeFilter_dashboard_div" style="border: 0px solid #ccc; text-align: left;">
									<table class="columns" style="width:100%">
							            ...
							            <tr>
							            	<td id="box">
								            	<div id="financialOutputChart" style="width: 100%; height: 400px;"></div>
							            	</td>
							            </tr>
							        </table>
						        </div>
					...
					<div class="col-md-12">
						<div class="panel panel-default container-fluid">
							<div class="panel-heading row" style="padding: 0px 19px 12px 0px !important;">
								<h5>
							...
							<div class="panel-body" id="divLifeGoals"  >
									...
									<tr ng-view ng-repeat="(i, lg) in lifeGoalsJson track by $index" repeat-done="layoutDone()">
										<td>				
											<select id="lgOptions" class="lgOptions" name="test" ng-model="lg.goalDescriptionId" ngChange="updateLifeGoals()">
											    ...
											    <option value="0" data-iconurl="img/icon_others.png" ng-selected="lg.goalDescriptionId==2">Others</option>
											</select>
											<input id="lgOther" class="lgOther" type="text" id="txtOthers" ng-show="lg.goalDescriptionId==2">
										</td>
										<td>
										...
										<td>
											<input type="text" class="form-control lgYear calender" aria-describedby="basic-addon1" ng-model="lg.yearofRealization">
										</td>
										<td width=400>
											<input type="text" class="form-control lgAmount txtRupee" aria-describedby="basic-addon1"  ng-model="lg.estimatedAmount">
										</td>
										<td style="padding-top:20px">
											<input type="checkbox" class="lgLoan" name="my-checkbox" ng-checked="lg.loanYesNo==true">
										</td>
										<td width=100>
								...
								<br><img id="btnAddRow" src="img/addRow.png" width="30px"  style="margin-right:50px" style="cursor: pointer;"><br>
								<button type="button" class="btn-flat inverse small "  onclick="javascript:location.reload();">Reset</button>
								<button type="button" class="btn-flat inverse small "  style="margin-right:10px" onclick="javascript:makeJsonLifeGoals();">Update</button>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<a href="/pages/v3/userReg.jsp" class="btn-flat success" style="width:100%; text-align: center;">
			...
			function initData(data){
				...
				for(i=0; i<data.lifeGoals.length; i++){
					...
					ligoalsJson = ligoalsJson + '{"y": 32, "shape": "url(img/goal_'+data.lifeGoals[i].goalDescriptionId+'.png)", "x": ' + data.lifeGoals[i].age + ', "titlex":"G", "frequency": '+data.lifeGoals[i].frequency+',"goalDescriptionId": '+data.lifeGoals[i].goalDescriptionId+',  "goalDescription" : "'+data.lifeGoals[i].goalDescription+'", "loanYesNo" : '+data.lifeGoals[i].loanYesNo+', "yearofRealization": '+data.lifeGoals[i].yearofRealization+'}';
				}
        ...
        <!-- Controllers -->
        <script src="js/controllers/FinancialPlannerOutput.js" charset="UTF-8"></script>
